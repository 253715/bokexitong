...
tag: markdown
readingTime: true
recommend: ['markdown',6]
date: 2025-05-07 10:42:00
---
...
[Markdown | VitePress](https://vitepress.yiov.top/markdown.html#%E5%AE%B9%E5%99%A8)
...
[样式美化 | VitePress](https://vitepress.yiov.top/style.html#%E5%AE%B9%E5%99%A8%E9%A2%9C%E8%89%B2)

### 新建css文件

>在 `theme/style` 新建 `custom-block.css` 文件

![image.png](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250507104811687.png)
...
![image.png](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250507105148835.png)

### index.ts中引入index

![image.png](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250507105332730.png)


## Obsidian

原生的Obsidian中不能够显示这种语法，但是可以安装一个插件（AnyBlock）来支持这个容器语法

![image.png](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250507110551889.png)
