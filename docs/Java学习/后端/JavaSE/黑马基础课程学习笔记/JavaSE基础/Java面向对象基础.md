...
![1662209848898](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932753.png)

遇到这样的需求，我们以前都会定义方法来做，如下图所示

注意：这里每一个方法有**三个参数**

![1662209886046](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932754.png)

![1662209899008](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932756.png)

定义好方法之后，我们调用方法的时候，需要给每一个方法**传递三个实际参数**

![1662210110729](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932757.png)
...
![1662210587156](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932758.png)
...
![1662211382446](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932759.png)
...
![1662211620054](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932760.png)
...
![1662212402342](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932761.png)
...
![1662213156309](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932762.png)

我们需要按照对象的设计图创造一个对象。**设计图中规定有哪些数据，对象中就只能有哪些数据。**

![1662213268590](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932763.png)
...
![1662213744520](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932764.png)
...
![1662213891968](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932766.png)
...
![1662214650611](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932767.png)

如下图所示，s1和s2两个变量记录的是同一个对象的地址值，s1修改对象的属性值，再用s2访问这个属性，会发现已经被修改了。

![1662215061486](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932768.png)
...
![1662301823320](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932769.png)

上面代码运行结果如下

![1662302089326](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932770.png)

**this有什么用呢？**

通过this在方法中可以访问本类对象的成员变量。我们看下图代码，分析打印结果是多少

![1662303254161](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932771.png)

分析上面的代码`s3.score=325`，调用方法printPass方法时，方法中的`this.score`也是325； 而方法中的参数score接收的是250。执行结果是

![1662303676092](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932772.png)
...
![1662304435504](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932773.png)
...
- **构造器的特点？**
  ...
  ![1662304779863](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932774.png)

  当执行`new Student("播仔",99)`创建对象时，就是在执行有参数构造器，当有参数构造器执行完，就意味着对象创建完毕了。

  ![1662304859276](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932775.png)
...
![1662305406056](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932776.png)
...
![1662305928023](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932777.png)
...
![1662306602412](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932778.png)

在设计汽车时，除了隐藏部分零件，但是还是得合理的暴露一些东西出来，让司机能够操纵汽车，让汽车跑起来。比如：点火按钮啊、方向盘啊、刹车啊、油门啊、档把啊... 这些就是故意暴露出来让司机操纵汽车的。

![1662306879230](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932779.png)
...
![1662307191295](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932780.png)
...
![1662335204398](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932781.png)

接下来我们按照要求，写一个Student实体类；

![1662335451401](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932782.png)
...
![1662336287570](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932783.png)
...
![1662337507608](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932784.png)
...
![1662351774659](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932785.png)

运行程序时，能够根据用户的选择，执行不同的功能，如下图所示

![1662351990387](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932786.png)
...
![1662371089114](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932787.png)

如下图所示，成员变量在类中方法外，而局部变量在方法中。

![1662353340190](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617161932789.png)
