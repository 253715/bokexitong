...
![1662602386634](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306143.png)
...
![1662605214383](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306144.png)

字符串的应用场景是非常多的，可以说是无处不在。

比如，在用户登录时，需要对用户名和密码进行校验，这里的用户名和密码都是String

![1662605347797](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306145.png)

再比如，在和网友聊天时，其实输入的文字就是一个一个字符串

![1662605396550](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306146.png)

再比如，在百度上搜索时，搜素的关键词，也是字符串

![1662605442842](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306147.png)

学习完String类之后，还会学习一个类ArrayList

![1662605519698](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306148.png)

大家知道数组是一个容器，有数组干嘛还要集合呢？	因为数字的长度是固定的，一旦创建不可改变。

比如数组的长度为3，想要存储第4个元素就存不进去了。

![1662605575865](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306149.png)
...
![1662605881879](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306150.png)
...
各位同学，接下来我们学习String这个类，也就是学对**字符串进行处理**。为什么要学习字符串处理呢？因为在开发中对于字符串的处理还是非常常见的。
...
![1662607669465](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306151.png)
...
![1662607801186](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306152.png)
...
![1662608166502](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306153.png)
...
![1662609378727](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306154.png)
...
![1662610060051](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306155.png)

- **注意事项1：String类的对象是不可变的对象**

我们先看一段代码，分析这段代码的结果

![1662610347618](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306156.png)

以上代码中，先定义了一个String变量 name第一次赋值为`“黑马”;` 然后对`name`变量记录的字符串进行两次拼接，第一次拼接`“程序员”`，第二次拼接`“播妞”`；我们发现得到的结果是：`黑马程序员播妞`

这里问题就来了，你不是是说：**String类的对象是不可变的字符串对象吗？**我看name的值变了呀！！！![1662610591674](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306157.png)
...
![1662610697641](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306158.png)

当执行第二句话时，又会再堆内存的常量池中创建一个字符串`“程序员”`，和`“黑马”`拼接，拼接之后还会产生一个新的字符串对象`”黑马程序员“`，然后将新产生的`“黑马程序员”`对象的地址赋值给`String name`变量。

![1662610978351](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306159.png)
...
![1662618688215](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306160.png)

![1662618651517](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306161.png)
...
![1662618819077](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306162.png)
...
![1662619371060](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306163.png)
...
ArrayList表示一种**集合**，它是一个容器，用来装数据的，类似于数组。那有了数组，为什么要有集合呢？
...
![1662620084702](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306164.png)

集合该怎么学呢？1. 首先你要会创建集合对象，2. 然后能够调用集合提供的方法对容器中的数据进行增删改查，3. 最后知道集合的一些特点就可以了。

![1662620152564](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306165.png)
...
![1662620389155](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306166.png)
...
![1662620686208](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306167.png)
...
![1662621705234](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306168.png)
...
![1662622656784](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306169.png)
...
![1662623052476](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306170.png)

![1662623321970](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306171.png)

![1662623468659](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306172.png)

![1662623624269](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306173.png)
...
![1662623794937](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306174.png)
...
![1662624841469](https://imgsbo.oss-cn-shanghai.aliyuncs.com/undefined20250617170306175.png)
